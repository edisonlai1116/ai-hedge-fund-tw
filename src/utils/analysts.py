...
ANALYST_CONFIG = {
    ...
    "gooaye_sentiment": {
        "display_name": "Gooaye (股癌) Consensus",
        "description": "股癌/輿情共識專家",
        "investing_style": "彙整股癌 Podcast 與社群輿情，經 WeightedConsensusEngine 加權後產生個股多空共識，作為買賣參考因素之一（台股覆蓋為主，無輿情資料時回中性）。",
